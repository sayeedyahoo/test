param workflows_logic_nrcan_oee_eve_prod_name string = 'logic-nrcan-oee-eve-prod'
param workflows_logic_nrcan_oee_incentive_calculators_prod_externalid string = '/subscriptions/a5df90be-e869-4159-83c2-db1ae389dce3/resourceGroups/nrcan-prod-oee-hd-shared-ca-central/providers/Microsoft.Logic/workflows/logic-nrcan-oee-incentive-calculators-prod'
param workflows_logic_nrcan_oee_file_management_prod_externalid string = '/subscriptions/a5df90be-e869-4159-83c2-db1ae389dce3/resourceGroups/nrcan-prod-oee-hd-shared-ca-central/providers/Microsoft.Logic/workflows/logic-nrcan-oee-file-management-prod'
param connections_keyvault_1_externalid string = '/subscriptions/a5df90be-e869-4159-83c2-db1ae389dce3/resourceGroups/nrcan-prod-oee-hd-shared-ca-central/providers/Microsoft.Web/connections/keyvault-1'

resource workflows_logic_nrcan_oee_eve_prod_name_resource 'Microsoft.Logic/workflows@2017-07-01' = {
  name: workflows_logic_nrcan_oee_eve_prod_name
  ...
  properties: {
                  ...
                  'logic-nrcan-oee-incentive-calculators-prod': {
                    ...
                    inputs: {
                      ...
                      host: {
                        triggerName: 'manual'
                        workflow: {
                          id: workflows_logic_nrcan_oee_incentive_calculators_prod_externalid
                        }
                      }
                    }
                  }
            ...
            Move_All_Files_from_Landing_Container: {
              ...
              inputs: {
                ...
                host: {
                  triggerName: 'manual'
                  workflow: {
                    id: workflows_logic_nrcan_oee_file_management_prod_externalid
                  }
                }
              }
            }
    ...
    parameters: {
      '$connections': {
        value: {
          keyvault: {
            connectionId: connections_keyvault_1_externalid
